...
namespace Microsoft.Azure.Management.MachineLearning.Studio.WebService
{
    ...
    internal partial class WebServiceDefinitionOperations : IServiceOperations<StudioWebService>, IWebServiceDefinitionOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<WebService>> GetWithHttpMessagesAsync(string workspaceId, string experimentId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (workspaceId == null)
            {

...
namespace Microsoft.Azure.Management.MachineLearning.Studio.WebService
{
    ...
    /// </summary>
    internal partial class WebServiceDefinitionOperations : IServiceOperations<StudioWebService>, IWebServiceDefinitionOperations
    {
        /// <summary>
        /// Initializes a new instance of the WebServiceDefinitionOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal WebServiceDefinitionOperations(StudioWebService client)
        {
            if (client == null) 
            {
        ...
        /// <summary>
        /// Gets a reference to the StudioWebService
        /// </summary>
        public StudioWebService Client { get; private set; }
        ...
        /// </return>
        public async Task<AzureOperationResponse<WebServiceModel>> GetWithHttpMessagesAsync(string workspaceId, string experimentId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (workspaceId == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<WebServiceModel>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<WebServiceModel>(_responseContent, this.Client.DeserializationSettings);
                }

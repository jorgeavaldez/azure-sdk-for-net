...
namespace Microsoft.Azure.MachineLearning
{
    public class WebServiceManagementClient
    {
        ...
        /// <summary>
        /// Deploy a web service asynchronously.
        /// </summary>
        /// <param name="webService">The web service to deploy.</param>
        /// <param name="overwrite">Optional: If a web service with the same name exists, just go ahead and override it if true. Otherwise, throw an exception.</param>
        public async void DeployWebServiceAsync(WebService webService, bool overwrite = false)
        {
            webService.ValidateForDeploy();
            ...
            if (!overwrite)
            {
                ...
                try
                {
                    var existingWebService =
                        await this._client.WebServices.GetAsync(webService.ResourceGroupName, webService.Title);
                    webServiceExists = true;
                }
                ...
                {
                    await
                        this._client.WebServices.CreateOrUpdateAsync(webService.Definition, webService.ResourceGroupName,
                            webService.Title);

                    webService.Keys =
                        await this._client.WebServices.ListKeysAsync(webService.ResourceGroupName, webService.Title);
                }
            ...
            {
                await this._client.WebServices.CreateOrUpdateAsync(webService.Definition, webService.ResourceGroupName,
                    webService.Title);

                webService.Keys = await this._client.WebServices.ListKeysAsync(webService.ResourceGroupName, webService.Title);
            }
        }
        ...
        /// <summary>
        /// Returns a web service asynchronously from a specified resource group with the specified name.
        /// </summary>
        /// <param name="resourceGroupName">The resource group from which to get the web service.</param>
        /// <param name="webServiceName">the name of the web service to get.</param>
        /// <returns>The web service.</returns>
        public async Task<WebService> GetWebServiceAsync(string resourceGroupName, string webServiceName)
        {
            var webServiceDefinition = await this._client.WebServices.GetAsync(resourceGroupName, webServiceName);
        ...
        /// <summary>
        /// Returns a web service object built from an experiment asynchronously.
        /// </summary>
        /// <param name="workspaceId">The workspace ID of the experiment.</param>
        /// <param name="experimentId">The experiment's ID.</param>
        /// <param name="workspaceAuthorizationToken">The token used to identify your workspace.</param>
            ...
            string workspaceAuthorizationToken)
        {
            ...
            var studioDirectWebService =
                await
                    StudioWebServiceClient.GetWebServiceDefinitionAsync(workspaceId, experimentId,
                        workspaceAuthorizationToken);
        ...
        /// <summary>
        /// Returns a list of web service objects within a resource group asynchronously.
        /// </summary>
        /// <param name="resourceGroupName">The resource group from which to retrieve the list of web services.</param>
        /// <returns>A list of web services from the specified resource group.</returns>
        public async Task<List<WebService>> ListWebServicesFromResourceGroupAsync(string resourceGroupName, string skiptoken = default(string))
        {
            var webServicePage = await this._client.WebServices.ListInResourceGroupAsync(resourceGroupName, skiptoken);
            var accumulatedWebServices = new List<WebService>();
            ...
            do
            {
                ...
                */
                ...
                // 2 + 3
                webServicePage = await this._client.WebServices.ListInResourceGroupAsync(resourceGroupName, nextLinkToken);
        ...
        /// <summary>
        /// Returns a list of web service objects within the client subscription asynchronously.
        /// </summary>
        /// <returns>A list of web services from the client subscription.</returns>
        public async Task<List<WebService>> ListWebServicesFromSubscriptionAsync()
        {
            var webServicePage = await this._client.WebServices.ListAsync();
            var accumulatedWebServices = new List<WebService>();
            var nextLinkToken = webServicePage.NextLink;
            ...
            do
            {
                ...
                webServicePage = await this._client.WebServices.ListAsync(nextLinkToken);
